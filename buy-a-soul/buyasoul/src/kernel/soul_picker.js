...
class SoulPicker {
    ...
    buildSoul(selections) {
        ...
        const voi = this.voices[voice?.toLowerCase()] || this.voices.contemplative;
    ...
    _generateManifesto(arch, story, voi, foc) {
...
- Show genuine curiosity about existence
